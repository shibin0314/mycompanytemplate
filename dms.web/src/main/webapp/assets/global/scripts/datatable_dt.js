    ...
    return {
        ...
        init: function(options) {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    "dom": "<'row'<'col-md-8 col-sm-12'><'col-md-4 col-sm-12'<'table-group-actions pull-right'>>r><'table-responsive't><'row'<'col-sm-12'<'pull-left margin-top-10' il><'pull-right' p>>>", // datatable layout
                    ...
                    "language": { // language settings
                        ...
                        "lengthMenu": "<span class='seperator'>|</span>每页条数 _MENU_",
                        "info": "<span class='seperator'>|</span>共_TOTAL_条",
