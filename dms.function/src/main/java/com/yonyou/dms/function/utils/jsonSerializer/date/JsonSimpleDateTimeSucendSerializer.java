...
public class JsonSimpleDateTimeSucendSerializer extends JsonSerializer<Date> {
    ...
    public void serialize(Date value, JsonGenerator gen, SerializerProvider serializers) throws IOException,
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat(CommonConstants.ACCURATE_DATE_FORMAT);
