...
public class JsonSimpleDateTimeSucendDeserializer extends JsonDeserializer<Date> {
    ...
    public Date deserialize(JsonParser p, DeserializationContext ctxt) throws IOException, JsonProcessingException {
        SimpleDateFormat format = new SimpleDateFormat(CommonConstants.ACCURATE_DATE_FORMAT);
